...
<div id="container">
    ...
    <div id="content">
		...
		<h3> FundraisingATM Representative Steps to $uccess</h3>

		<p>Welcome.  As a FundraisingATM Representative you will get to help your surrounding community reach their goals while earning a residual
	...
	getting them setup with their Free Fundraising website program (with our help).  </p>
		...
		<p>Once you lockup your Free Fundraising Website accounts, you lockout the competition. First come, first serve.  Nobody is going to change from the FundraisingATM Free Fundraising Website Program once it is setup, as long as you support the fundraising leaders and we continue to update the products and software features. </p>

		<br>

		<h3> FundraisingATM Representative Responsibility Summary,<br>Simple Steps to get groups to sign up for fundraisers: </h3>
		<ul class="bulletedlist">
			...
			<li>Explain and Show them the FundraisingATMMoods Free Online Program</li>
