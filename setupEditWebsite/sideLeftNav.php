            ...
            <div class="panel text-center">
                ...
                <div class="sidenavList nav nav-pills nav-stacked"> <!-- start program overview list block -->
                    ...
                    <ul id="sidenavSection1" class="nav nav-pills nav-stacked collapse">
                        ...
                        <!--<li><a href="fundgettingstarted11.php"><i class="fa fa-desktop navicon"></i> GreatMoods<br>Program Overview</a></li>-->
                        <li><a href="gm_program.php" title=""><i class="fa fa-list-ol navicon"></i> FundraisingATM Program</a></li> 
                ...
                <div id="accountAdministration-sideNav" class="sidenavList nav nav-pills nav-stacked">
                    ...
                    <ul id="sidenavSection3" class="nav nav-pills nav-stacked collapse in">
                        ...
                        <li><a href="editClub.php" title="View Representatives"><i class="fa fa-users"></i> View Team Accounts</a></li>
                        ...
                        <li><a href="contacts.php" title=""><i class="fa fa-user-plus" aria-hidden="true"></i>View Contacts</a></li>
                        <li><a href="create.php" title=""><i class="fa fa-user-plus" aria-hidden="true"></i>Add Member Contacts</a></li>
