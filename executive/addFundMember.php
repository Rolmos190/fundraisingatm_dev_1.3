...
<div id="container">
      ...
      <form class="graybackground" action="addRep.php" method="POST" enctype="multipart/form-data" id="myForm" name="myForm" onsubmit="return(validate());">
				<h2><b>--Option 1: Add One Member--</b></h2>
			<div class="tablerow">
			...
			<div class="simpleTabs">
				...
				<div>
					<br>
							...
							<span>Member Title: </span>	<!--<span>[Group] Leader Type: </span> [Group] = same as the selected group above -->
							<select name="">
...
<div id="Four" class="tabcontent">
  <div class="table" style="width:100%">
	 ...
	 <div class="table">
	 	<form class="graybackground" action="addRep.php" method="POST" enctype="multipart/form-data" id="myForm" name="myForm" onsubmit="return(validate());">
	 		<h2><b>--Option 2: Add Multiple Members--</b></h2>
			<br>
			<h2 style="color: #cc0000">How To Add Multiple Members</h2>
			<ol>
